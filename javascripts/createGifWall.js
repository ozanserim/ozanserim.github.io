...
/*
//ADD Radio
var radio = Entities.addEntity({
    type: "Model",
    modelURL: "https://hifi-content.s3.amazonaws.com/ozan/dev/props/radio/radio.fbx",
    position: {x:0, y:0 , z:0},
    position: MyAvatar.position,
    shapeType: 'box',
    dimensions: {x: 1.6, y: 0.8390, z: 0.0100}
});
*/

var myEntity1 = Entities.addEntity({
    type: "Web",
    //position: MyAvatar.position,
    position: { x: 0, y: 0, z: -10 },
    sourceUrl: "https://hifi-metaverse.s3-us-west-1.amazonaws.com/snapshots/images/hifi-snap-original-1175.gif",
    dimensions: { x: 1.6, y: 0.8390, z: 0.0100 },
    dpi: "11"

});

var myEntity2 = Entities.addEntity({
    type: "Web",
    //position: MyAvatar.position,
    position: { x: 0, y: 1, z: -10 },
    sourceUrl: "https://hifi-metaverse.s3-us-west-1.amazonaws.com/snapshots/images/hifi-snap-original-1174.gif",
    dimensions: { x: 1.6, y: 0.8390, z: 0.0100 },
    dpi: "11"
...
var webEntity = Entities.addEntity({
    type: "Web",
    url: "https://hifi-metaverse.s3-us-west-1.amazonaws.com/snapshots/images/hifi-snap-original-1175.gif",
