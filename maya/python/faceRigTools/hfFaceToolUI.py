...
class Window(form_class, base_class):
    ...
    def __init__(self, parent=qt_lib.getMayaWindow()):
        ...
        self.transferControlToPosition_pushButton.clicked.connect(self.transferControlToPositionGroup)
    ...
    def transferControlToPositionGroup(self):
        faceRigUtils.transferControlToPositionGroup()
